# LearningToDetect for CMDNet

The original DetNet code from [3] was downloaded, modified and resimulated for comparison to CMDNet enabling high reproducibility of PhD thesis [1] and publication [2]:
...
3. N. Samuel, T. Diskin, and A. Wiesel, “Learning to Detect,” IEEE Transactions on Signal Processing, vol. 67, no. 10, pp. 2554–2564, May 2019. https://doi.org/10.1109/TSP.2019.2899805.

The new main files end with `_CMDNet.py` and cover the respective original files cases.